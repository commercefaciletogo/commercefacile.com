...
@section('main')
    ...
    <div id="main">
        <div class="ui container center aligned"
             style="padding-top: 1.5em; padding-bottom: 5em; background: #fff; border-left: 1px solid #a4acbe; border-right: 1px solid #a4acbe;">

            <h2 class="header" style="margin-bottom: 1em; color: #33446d;">{{ trans('general.edit_ad') }}</h2>

            <div v-cloak :class="['ui ', {loading:busy}, ' segment']"
                ...
                <div class="ui two column centered grid">
                    <div class="twelve wide computer fourteen wide tablet fourteen wide mobile column"
                        ...
                        <div class="ui dividing header"
                             style="text-transform: capitalize; font-weight: normal;">{{ trans('general.ad_information') }}</div>

                        <div class="ui grid row">
                            <div class="three wide computer three wide tablet only column">
                                <label>{{ trans('general.ad_title') }}</label></div>
                            <div class="eight wide computer eight wide tablet sixteen wide mobile column">
                                <div :class="['ui small fluid', {error: errors.title}, 'input']">
                                    <input type="text" v-model="newAd.title"
                                           placeholder="{{ trans('general.ad_title') }}">
                                </div>
                            </div>
                        ...
                        <div class="ui grid row">
                            <div class="three wide computer three wide tablet only column">
                                <label>{{ trans('general.condition') }}</label></div>
                            <div class="eight wide computer eight wide tablet sixteen wide mobile column">
                                <div class="ui grid">
                        ...
                        <div class="ui grid row">
                            <div class="three wide computer three wide tablet only column">
                                <label>{{ trans('general.ad_description') }}</label></div>
                            <div class="eight wide computer eight wide tablet sixteen wide mobile column">
                                <div class="ui small fluid input">
                                    <textarea :class="[{error: errors.description}]" v-model="newAd.description"
                        ...
                        <div class="ui grid row">
                            <div class="three wide computer three wide tablet only column">
                                <label>{{ trans('general.ad_images') }}</label></div>
                            <div class="eight wide computer eight wide tablet sixteen wide mobile column">
                                <div class="ui grid">
                                    <div class="six wide computer tablet column">
                                        <div style="position: relative;overflow: hidden;">
                                            <input id="fileInput" accept="image/jpg" type="file" class="custom" @change=
                                            ...
                                            ;">
                                            <label for="fileInput"
                                                   :class="[moreImageDefaultStyle, errors.images ? 'error' : '', moreImage ? '' : 'disabled']"
                        ...
                        <div class="ui grid row">
                            <div class="three wide computer three wide tablet only column">
                                <label>{{ trans('general.ad_price') }}</label></div>
                            <div class="eight wide computer eight wide tablet sixteen wide mobile column">
                                <div class="ui grid">
                                    <div class="ten wide column">
                                        <div :class="['ui right small labeled fluid', {error: errors.price}, 'input']">
                                            <input v-model="newAd.price.amount" type="number"
                                                   placeholder="{{ trans('general.ad_price') }}">
                                            <div class="ui basic label" style="font-weight: 100; color: #4a597d;">FCFA
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="ui grid row">
                            <div class="three wide computer three wide tablet sixteen wide mobile column right aligned">
                                <button @click.prevent="cancel"
                                        class="ui fluid button">{{ trans('general.cancel') }}</button>
                            </div>
                            <div class="eight wide computer eight wide tablet only column">
                            </div>
                            <div class="three wide computer three wide tablet sixteen wide mobile column right aligned">
                                <button @click.prevent="submit"
                                        class="ui fluid button">{{ trans('general.submit') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="remodal" data-remodal-id="choose-category" id="chooseCategory"
             data-remodal-options="closeOnOutsideClick: false">
            <button data-remodal-action="close" class="remodal-close"></button>
            <div class="ui container left aligned">
                <div class="ui styled accordion">
                    <option-item @selected="closeCategoryModal"  v-for="category in categories" :item="category"
                    ></option-item>
                </div>
            </div>
        </div>

        <div class="remodal" data-remodal-id="choose-location" id="chooseLocation"
             data-remodal-options="closeOnOutsideClick: false">
            <button data-remodal-action="close" class="remodal-close"></button>
            <div class="ui container left aligned">
                <div class="ui styled accordion">
                    <option-item @selected="closeLocationModal"  v-for="location in locations" :item="location"
                    ></option-item>
                </div>
            </div>
        </div>
